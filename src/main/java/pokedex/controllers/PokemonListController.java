...
public class PokemonListController extends BaseController {
    ...
    Map<Integer, pokedex.entities.Pokemon> pokemonMap = new TreeMap<>();
    int totalPokemon = 0;
    ...
    public Map<Integer, pokedex.entities.Pokemon> getPokemonMap() {
        ...
        if (null != pokemonList && !pokemonList.getResults().isEmpty()) {
            ...
            listOfPokemon.parallelStream().forEach(pkmn -> {
                ...
                pokedex.entities.Pokemon pokemon = new pokedex.entities.Pokemon(pokemonResource);
