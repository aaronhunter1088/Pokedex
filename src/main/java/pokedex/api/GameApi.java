...
//
//    @Autowired
//    GameApi(PokemonService pokemonService, PokeApiClient pokeApiClient)
//    {
...
//    @ResponseBody
//    public ResponseEntity<?> getGeneration(@PathVariable int id)
//    {
...
//    @ResponseBody
//    public ResponseEntity<?> getPokedex(@PathVariable int id)
//    {
...
//    @ResponseBody
//    public ResponseEntity<?> getVersionGroup(@PathVariable int id)
//    {
